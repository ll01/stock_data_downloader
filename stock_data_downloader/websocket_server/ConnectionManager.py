...
class ConnectionManager:
    def __init__(self, max_in_flight_messages: int = 10, max_prio_messages: int = 5, max_error_threshold: int = 5, start_health_check: bool = True):
        ...
        self.connection_queues: Dict[WebSocketServerProtocol, SocketQueues] = {}
        self.error_counts: Dict[WebSocketServerProtocol, int] = {}
        ...
        self.sender_tasks: Dict[WebSocketServerProtocol, asyncio.Task] = {}
        ...
        self._sockets_by_client: Dict[str, WebSocketServerProtocol] = {}
    ...
    async def add_connection(self, websocket: WebSocketServerProtocol, enqueue_welcome: bool = True) -> None:
        """
    ...
    def assign_client_id(self, websocket: WebSocketServerProtocol) -> str:
    ...
    def update_connection_info(self, websocket: WebSocketServerProtocol, info: Dict):
    ...
    def get_socket(self, client_id: str) -> Optional[WebSocketServerProtocol]:
    ...
    async def send(
        ...
        def _sanitize(obj):
            ...
            if hasattr(obj, "remote_address") and hasattr(obj, "send"):
                try:
                    return f"<WebSocketServerProtocol {getattr(obj, 'remote_address', '')}>"
                except Exception:
    ...
    def increment_error_count(self, websocket: WebSocketServerProtocol) -> int:
        self.error_counts[websocket] = self.error_counts.get(websocket, 0) + 1
        self.stats["errors"] += 1
        return self.error_counts[websocket]
        
    def get_error_count(self, websocket: WebSocketServerProtocol) -> int:
    ...
    async def _sender_task(self, websocket: WebSocketServerProtocol) -> None:
